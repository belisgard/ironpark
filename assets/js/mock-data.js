...
const mockData = {
  ...
  financeTransactions: [
    ...
    { id: 6, driverId: 1, date: '2025-12-23', section: 'Штраф', time: '12:40:15', income: 0, expense: 5000, balance: -4350, paymentMethod: 'Внутренний', description: 'Оплата штрафа #1' },
    { id: 7, driverId: 1, date: '2025-12-22', section: 'Штраф', time: '11:22:09', income: 0, expense: 3000, balance: -7350, paymentMethod: 'Внутренний', description: 'Оплата штрафа #2' },
    { id: 8, driverId: 1, date: '2025-12-21', section: 'Штраф', time: '10:05:44', income: 0, expense: 2000, balance: -9350, paymentMethod: 'Внутренний', description: 'Оплата штрафа #3' }
  ]
};
