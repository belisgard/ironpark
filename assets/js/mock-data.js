...
const mockData = {
  cars: [
    ...
    { id: 2, plate: 'В456ГД777', brand: 'Hyundai', model: 'Solaris', vin: 'Z94CB41AAGR123456', sts: '77СТ123457', status: 'Свободен', currentDriver: null, mileage: 89000, category: 'Эконом', curator: 'Сидоров С.С.', hasFines: false, insuranceExpiringDays: 120, hasDebt: false, fuelType: 'АИ-95' },
    { id: 3, plate: 'С789ЕЖ777', brand: 'Kia', model: 'Rio', vin: 'Z94CB41AAHR123456', sts: '77СТ123458', status: 'В ремонте', currentDriver: null, mileage: 156000, category: 'Эконом', curator: 'Петров П.П.', hasFines: false, insuranceExpiringDays: 8, hasDebt: false, fuelType: 'АИ-92' },
    { id: 4, plate: 'Д012ЗИ777', brand: 'Volkswagen', model: 'Polo', vin: 'WVWZZZ6RZHY123456', sts: '77СТ123459', status: 'Просрочка', currentDriver: 'Смирнов Сергей Сергеевич', mileage: 98000, category: 'Комфорт', curator: 'Сидоров С.С.', hasFines: true, insuranceExpiringDays: 200, hasDebt: true, fuelType: 'АИ-95' },
    { id: 5, plate: 'Е345КЛ777', brand: 'Skoda', model: 'Octavia', vin: 'TMBBA21Z1C2123456', sts: '77СТ123460', status: 'На линии', currentDriver: 'Козлов Константин Константинович', mileage: 112000, category: 'Комфорт', curator: 'Петров П.П.', hasFines: false, insuranceExpiringDays: 15, hasDebt: false, fuelType: 'АИ-95' },
    { id: 6, plate: 'Ж678МН777', brand: 'Toyota', model: 'Corolla', vin: 'JTNBF4HKXJ1234568', sts: '77СТ123461', status: 'Свободен', currentDriver: null, mileage: 67000, category: 'Эконом', curator: 'Сидоров С.С.', hasFines: false, insuranceExpiringDays: 90, hasDebt: false, fuelType: 'АИ-95' },
    { id: 7, plate: 'З901ОП777', brand: 'Nissan', model: 'Almera', vin: 'JN1AZ4EH0FM123456', sts: '77СТ123462', status: 'На линии', currentDriver: 'Новиков Николай Николаевич', mileage: 134000, category: 'Эконом', curator: 'Петров П.П.', hasFines: true, insuranceExpiringDays: 5, hasDebt: false, fuelType: 'АИ-92' },
    { id: 8, plate: 'И234РС777', brand: 'Lada', model: 'Granta', vin: 'XTA219060K1234567', sts: '77СТ123463', status: 'В ремонте', currentDriver: null, mileage: 178000, category: 'Эконом', curator: 'Сидоров С.С.', hasFines: false, insuranceExpiringDays: 30, hasDebt: false, fuelType: 'АИ-92' },
    { id: 9, plate: 'К567ТУ777', brand: 'Hyundai', model: 'Elantra', vin: 'Z94CB41AAGR123457', sts: '77СТ123464', status: 'Просрочка', currentDriver: 'Федоров Федор Федорович', mileage: 101000, category: 'Комфорт', curator: 'Петров П.П.', hasFines: true, insuranceExpiringDays: 180, hasDebt: true, fuelType: 'АИ-95' },
    { id: 10, plate: 'Л890ФХ777', brand: 'Kia', model: 'Cerato', vin: 'Z94CB41AAHR123457', sts: '77СТ123465', status: 'На линии', currentDriver: 'Морозов Михаил Михайлович', mileage: 89000, category: 'Комфорт', curator: 'Сидоров С.С.', hasFines: false, insuranceExpiringDays: 60, hasDebt: false, fuelType: 'АИ-95' },
    { id: 11, plate: 'М123ЦЧ777', brand: 'Toyota', model: 'Camry', vin: 'JTNBF4HKXJ1234569', sts: '77СТ123466', status: 'Свободен', currentDriver: null, mileage: 45000, category: 'Комфорт', curator: 'Петров П.П.', hasFines: false, insuranceExpiringDays: 150, hasDebt: false, fuelType: 'АИ-95' },
    { id: 12, plate: 'Н456ШЩ777', brand: 'Volkswagen', model: 'Jetta', vin: 'WVWZZZ6RZHY123457', sts: '77СТ123467', status: 'На линии', currentDriver: 'Волков Владимир Владимирович', mileage: 123000, category: 'Комфорт', curator: 'Сидоров С.С.', hasFines: false, insuranceExpiringDays: 25, hasDebt: false, fuelType: 'АИ-95' }
  ],
