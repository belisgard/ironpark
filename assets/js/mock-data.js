...
const mockData = {
  ...
  inspections: [
    { id: 1, date: '2024-01-25T10:30:00', plate: 'А123БВ777', type: 'Выдача', mechanicName: 'Механиков М.М.', driverName: 'Иванов Иван Иванович', mileage: 125000, hasDamages: false, hasIncomplete: false, hasLostDocuments: false, notes: 'Все в порядке', photos: [{ url: '../assets/img/placeholder.png', name: 'Фото 1' }, { url: '../assets/img/placeholder.png', name: 'Фото 2' }, { url: '../assets/img/placeholder.png', name: 'Фото 3' }], clientSignatureUrl: '../assets/img/placeholder.png' },
    { id: 2, date: '2024-01-20T14:15:00', plate: 'Е345КЛ777', type: 'Выдача', mechanicName: 'Механиков М.М.', driverName: 'Козлов Константин Константинович', mileage: 112000, hasDamages: false, hasIncomplete: false, hasLostDocuments: false, notes: 'Комплектность полная', photos: [{ url: '../assets/img/placeholder.png', name: 'Фото 1' }, { url: '../assets/img/placeholder.png', name: 'Фото 2' }], clientSignatureUrl: '../assets/img/placeholder.png' },
    { id: 3, date: '2024-01-18T09:45:00', plate: 'З901ОП777', type: 'Возврат', mechanicName: 'Слесарев С.С.', driverName: 'Новиков Николай Николаевич', mileage: 134500, hasDamages: true, hasIncomplete: false, hasLostDocuments: false, notes: 'Царапина на заднем бампере', photos: [{ url: '../assets/img/placeholder.png', name: 'Фото 1' }, { url: '../assets/img/placeholder.png', name: 'Фото 2' }, { url: '../assets/img/placeholder.png', name: 'Фото 3' }, { url: '../assets/img/placeholder.png', name: 'Фото 4' }], clientSignatureUrl: '../assets/img/placeholder.png' },
    { id: 4, date: '2024-01-15T16:20:00', plate: 'Л890ФХ777', type: 'Плановый', mechanicName: 'Слесарев С.С.', driverName: 'Морозов Михаил Михайлович', mileage: 89000, hasDamages: false, hasIncomplete: false, hasLostDocuments: false, notes: null, photos: [], clientSignatureUrl: null },
    { id: 5, date: '2024-01-12T11:00:00', plate: 'Н456ШЩ777', type: 'Выдача', mechanicName: 'Механиков М.М.', driverName: 'Волков Владимир Владимирович', mileage: 123000, hasDamages: false, hasIncomplete: true, hasLostDocuments: false, notes: 'Отличное состояние', photos: [{ url: '../assets/img/placeholder.png', name: 'Фото 1' }], clientSignatureUrl: '../assets/img/placeholder.png' },
    { id: 6, date: '2024-01-10T13:30:00', plate: 'А123БВ777', type: 'Возврат', mechanicName: 'Механиков М.М.', driverName: 'Иванов Иван Иванович', mileage: 125200, hasDamages: false, hasIncomplete: false, hasLostDocuments: true, notes: null, photos: [{ url: '../assets/img/placeholder.png', name: 'Фото 1' }, { url: '../assets/img/placeholder.png', name: 'Фото 2' }, { url: '../assets/img/placeholder.png', name: 'Фото 3' }], clientSignatureUrl: '../assets/img/placeholder.png' },
    { id: 7, date: '2024-01-08T08:15:00', plate: 'М123ЦЧ777', type: 'Выдача', mechanicName: 'Слесарев С.С.', driverName: null, mileage: 45000, hasDamages: false, hasIncomplete: false, hasLostDocuments: false, notes: 'Новое авто', photos: [{ url: '../assets/img/placeholder.png', name: 'Фото 1' }, { url: '../assets/img/placeholder.png', name: 'Фото 2' }], clientSignatureUrl: '../assets/img/placeholder.png' },
    { id: 8, date: '2024-01-05T15:45:00', plate: 'К567ТУ777', type: 'Возврат', mechanicName: 'Механиков М.М.', driverName: 'Федоров Федор Федорович', mileage: 101500, hasDamages: true, hasIncomplete: false, hasLostDocuments: false, notes: 'Трещина на лобовом стекле', photos: [{ url: '../assets/img/placeholder.png', name: 'Фото 1' }, { url: '../assets/img/placeholder.png', name: 'Фото 2' }, { url: '../assets/img/placeholder.png', name: 'Фото 3' }], clientSignatureUrl: '../assets/img/placeholder.png' },
    { id: 9, date: '2024-01-03T10:00:00', plate: 'В456ГД777', type: 'Плановый', mechanicName: 'Слесарев С.С.', driverName: null, mileage: 89000, hasDamages: false, hasIncomplete: false, hasLostDocuments: false, notes: null, photos: [], clientSignatureUrl: null },
    { id: 10, date: '2023-12-30T12:00:00', plate: 'Д012ЗИ777', type: 'Возврат', mechanicName: 'Механиков М.М.', driverName: 'Смирнов Сергей Сергеевич', mileage: 98000, hasDamages: false, hasIncomplete: false, hasLostDocuments: false, notes: 'Все исправно', photos: [{ url: '../assets/img/placeholder.png', name: 'Фото 1' }, { url: '../assets/img/placeholder.png', name: 'Фото 2' }], clientSignatureUrl: '../assets/img/placeholder.png' }
  ],
  ...
  financeTransactions: [
    // Иванов Сергей Петрович (id=1) — Договор ДР-2024-001, ТС K477MB122
    { id: 1,  driverId: 1, driverName: 'Иванов Сергей Петрович',           date: '2026-04-22', time: '09:10', type: 'Поступление аренды',   status: 'Выполнено',        amount: 2550, description: 'Договор №ДР-2024-001, ТС K477MB122' },
    { id: 2,  driverId: 1, driverName: 'Иванов Сергей Петрович',           date: '2026-04-21', time: '18:00', type: 'Компенсация штрафа',   status: 'Выполнено',        amount: 5000, description: 'Договор №ДР-2024-001, ТС K477MB122, штраф №202604120042' },
    { id: 3,  driverId: 1, driverName: 'Иванов Сергей Петрович',           date: '2026-04-20', time: '11:22', type: 'Поступление аренды',   status: 'Выполнено',        amount: 2550, description: 'Договор №ДР-2024-001, ТС K477MB122' },
    { id: 4,  driverId: 1, driverName: 'Иванов Сергей Петрович',           date: '2026-04-18', time: '10:05', type: 'Компенсация штрафа',   status: 'Ошибка списания',  amount: 3000, description: 'Договор №ДР-2024-001, ТС K477MB122, штраф №202603280031', errorComment: 'Недостаточно средств на балансе водителя' },
    // Смирнов Сергей Сергеевич (id=2) — Договор ДР-2024-078, ТС Д012ЗИ777
    { id: 5,  driverId: 2, driverName: 'Смирнов Сергей Сергеевич',         date: '2026-04-22', time: '08:45', type: 'Поступление аренды',   status: 'Выполнено',        amount: 6000, description: 'Договор №ДР-2024-078, ТС Д012ЗИ777' },
    { id: 6,  driverId: 2, driverName: 'Смирнов Сергей Сергеевич',         date: '2026-04-21', time: '18:00', type: 'Компенсация штрафа',   status: 'Выполнено',        amount: 7000, description: 'Договор №ДР-2024-078, ТС Д012ЗИ777, штраф №202604050017' },
    { id: 7,  driverId: 2, driverName: 'Смирнов Сергей Сергеевич',         date: '2026-04-19', time: '09:30', type: 'Поступление аренды',   status: 'Ошибка списания',  amount: 6000, description: 'Договор №ДР-2024-078, ТС Д012ЗИ777', errorComment: 'Недостаточно средств на балансе водителя' },
    // Козлов Константин Константинович (id=3) — Договор ДР-2024-023, ТС Е345КЛ777
    { id: 8,  driverId: 3, driverName: 'Козлов Константин Константинович', date: '2026-04-23', time: '07:58', type: 'Поступление аренды',   status: 'Выполнено',        amount: 5500, description: 'Договор №ДР-2024-023, ТС Е345КЛ777' },
    { id: 9,  driverId: 3, driverName: 'Козлов Константин Константинович', date: '2026-04-22', time: '14:10', type: 'Компенсация штрафа',   status: 'Выполнено',        amount: 1500, description: 'Договор №ДР-2024-023, ТС Е345КЛ777, штраф №202604010008' },
    // Новиков Николай Николаевич (id=4) — Договор ДР-2024-089, ТС З901ОП777
    { id: 10, driverId: 4, driverName: 'Новиков Николай Николаевич',       date: '2026-04-22', time: '12:00', type: 'Поступление аренды',   status: 'Выполнено',        amount: 5000, description: 'Договор №ДР-2024-089, ТС З901ОП777' },
    { id: 11, driverId: 4, driverName: 'Новиков Николай Николаевич',       date: '2026-04-20', time: '11:15', type: 'Поступление аренды',   status: 'Выполнено',        amount: 5000, description: 'Договор №ДР-2024-089, ТС З901ОП777' },
    // Федоров Федор Федорович (id=5) — Договор ДР-2024-067, ТС К567ТУ777
    { id: 12, driverId: 5, driverName: 'Федоров Федор Федорович',          date: '2026-04-23', time: '08:20', type: 'Поступление аренды',   status: 'Выполнено',        amount: 6000, description: 'Договор №ДР-2024-067, ТС К567ТУ777' },
    { id: 13, driverId: 5, driverName: 'Федоров Федор Федорович',          date: '2026-04-21', time: '18:00', type: 'Компенсация штрафа',   status: 'Выполнено',        amount: 4500, description: 'Договор №ДР-2024-067, ТС К567ТУ777, штраф №202603150023' },
    { id: 14, driverId: 5, driverName: 'Федоров Федор Федорович',          date: '2026-04-20', time: '10:40', type: 'Компенсация штрафа',   status: 'Ошибка списания',  amount: 7500, description: 'Договор №ДР-2024-067, ТС К567ТУ777, штраф №202602200011', errorComment: 'Баланс водителя заблокирован' },
    // Морозов Михаил Михайлович (id=6) — Договор ДР-2024-112, ТС Л890ФХ777
    { id: 15, driverId: 6, driverName: 'Морозов Михаил Михайлович',        date: '2026-04-22', time: '09:05', type: 'Поступление аренды',   status: 'Выполнено',        amount: 5500, description: 'Договор №ДР-2024-112, ТС Л890ФХ777' },
    { id: 16, driverId: 6, driverName: 'Морозов Михаил Михайлович',        date: '2026-04-21', time: '13:30', type: 'Поступление аренды',   status: 'Выполнено',        amount: 5500, description: 'Договор №ДР-2024-112, ТС Л890ФХ777' },
    // Волков Владимир Владимирович (id=7) — Договор ДР-2024-134, ТС Н456ШЩ777
    { id: 17, driverId: 7, driverName: 'Волков Владимир Владимирович',     date: '2026-04-23', time: '10:15', type: 'Поступление аренды',   status: 'Выполнено',        amount: 6000, description: 'Договор №ДР-2024-134, ТС Н456ШЩ777' },
    { id: 18, driverId: 7, driverName: 'Волков Владимир Владимирович',     date: '2026-04-22', time: '15:45', type: 'Компенсация штрафа',   status: 'Выполнено',        amount: 2000, description: 'Договор №ДР-2024-134, ТС Н456ШЩ777, штраф №202604080029' }
  ],

  parkOperations: [
    { id: 1,  dateTime: '2026-04-23T10:15:00', type: 'Вывод средств', amount: 150000, status: 'Исполнено',  account: 'Р/с 40702810000000000001, ПАО Сбербанк',        comment: 'Плановый вывод за неделю' },
    { id: 2,  dateTime: '2026-04-21T14:30:00', type: 'Вывод средств', amount: 200000, status: 'Ожидает исполнения', account: 'Р/с 40702810000000000001, ПАО Сбербанк',  comment: 'Ожидает подтверждения банка' },
    { id: 3,  dateTime: '2026-04-20T09:05:00', type: 'Вывод средств', amount: 185000, status: 'Исполнено',  account: 'Р/с 40702810000000000001, ПАО Сбербанк',        comment: 'Замена операции #2' },
    { id: 4,  dateTime: '2026-04-18T16:45:00', type: 'Вывод средств', amount: 95000,  status: 'Отклонено',  account: 'Р/с 40702810099900000045, ТБанк',                comment: 'Отклонено: реквизиты не совпадают с данными профиля' },
    { id: 5,  dateTime: '2026-04-17T11:20:00', type: 'Вывод средств', amount: 120000, status: 'Исполнено',  account: 'Р/с 40702810000000000001, ПАО Сбербанк',        comment: 'Внеплановый вывод' },
    { id: 6,  dateTime: '2026-04-15T10:00:00', type: 'Вывод средств', amount: 250000, status: 'Исполнено',  account: 'Р/с 40702810000000000001, ПАО Сбербанк',        comment: 'Плановый вывод за неделю' },
    { id: 7,  dateTime: '2026-04-12T13:55:00', type: 'Вывод средств', amount: 75000,  status: 'Отклонено',  account: 'Р/с 40702810099900000045, ТБанк',                comment: 'Отклонено: превышение лимита разовой операции' },
    { id: 8,  dateTime: '2026-04-10T09:30:00', type: 'Вывод средств', amount: 180000, status: 'Исполнено',  account: 'Р/с 40702810000000000001, ПАО Сбербанк',        comment: 'Плановый вывод' },
    { id: 9,  dateTime: '2026-04-07T15:10:00', type: 'Вывод средств', amount: 300000, status: 'Исполнено',  account: 'Р/с 40702810000000000001, ПАО Сбербанк',        comment: 'Крупный вывод, согласован с куратором' },
    { id: 10, dateTime: '2026-04-04T10:45:00', type: 'Вывод средств', amount: 140000, status: 'Ожидает исполнения', account: 'Р/с 40702810099900000045, ТБанк',          comment: 'Ожидает проверки реквизитов' }
  ],

  parkFinance: {
    balance: 2458300,
    availableBalance: 1924700,
    lastUpdated: '2026-04-23T10:30:00'
  }
};
