...
const mockData = {
  cars: [
    ...
    { id: 2, plate: 'В456ГД777', brand: 'Hyundai', model: 'Solaris', vin: 'Z94CB41AAGR123456', sts: '77СТ123457', status: 'Свободен', currentDriver: null, mileage: 89000, category: 'Эконом', curator: 'Сидоров С.С.', hasFines: false, insuranceExpiringDays: 120, hasDebt: false },
    { id: 3, plate: 'С789ЕЖ777', brand: 'Kia', model: 'Rio', vin: 'Z94CB41AAHR123456', sts: '77СТ123458', status: 'В ремонте', currentDriver: null, mileage: 156000, category: 'Эконом', curator: 'Петров П.П.', hasFines: false, insuranceExpiringDays: 8, hasDebt: false },
    { id: 4, plate: 'Д012ЗИ777', brand: 'Volkswagen', model: 'Polo', vin: 'WVWZZZ6RZHY123456', sts: '77СТ123459', status: 'Просрочка', currentDriver: 'Смирнов Сергей Сергеевич', mileage: 98000, category: 'Комфорт', curator: 'Сидоров С.С.', hasFines: true, insuranceExpiringDays: 200, hasDebt: true },
    { id: 5, plate: 'Е345КЛ777', brand: 'Skoda', model: 'Octavia', vin: 'TMBBA21Z1C2123456', sts: '77СТ123460', status: 'На линии', currentDriver: 'Козлов Константин Константинович', mileage: 112000, category: 'Комфорт', curator: 'Петров П.П.', hasFines: false, insuranceExpiringDays: 15, hasDebt: false },
    { id: 6, plate: 'Ж678МН777', brand: 'Toyota', model: 'Corolla', vin: 'JTNBF4HKXJ1234568', sts: '77СТ123461', status: 'Свободен', currentDriver: null, mileage: 67000, category: 'Эконом', curator: 'Сидоров С.С.', hasFines: false, insuranceExpiringDays: 90, hasDebt: false },
    { id: 7, plate: 'З901ОП777', brand: 'Nissan', model: 'Almera', vin: 'JN1AZ4EH0FM123456', sts: '77СТ123462', status: 'На линии', currentDriver: 'Новиков Николай Николаевич', mileage: 134000, category: 'Эконом', curator: 'Петров П.П.', hasFines: true, insuranceExpiringDays: 5, hasDebt: false },
    { id: 8, plate: 'И234РС777', brand: 'Lada', model: 'Granta', vin: 'XTA219060K1234567', sts: '77СТ123463', status: 'В ремонте', currentDriver: null, mileage: 178000, category: 'Эконом', curator: 'Сидоров С.С.', hasFines: false, insuranceExpiringDays: 30, hasDebt: false },
    { id: 9, plate: 'К567ТУ777', brand: 'Hyundai', model: 'Elantra', vin: 'Z94CB41AAGR123457', sts: '77СТ123464', status: 'Просрочка', currentDriver: 'Федоров Федор Федорович', mileage: 101000, category: 'Комфорт', curator: 'Петров П.П.', hasFines: true, insuranceExpiringDays: 180, hasDebt: true },
    { id: 10, plate: 'Л890ФХ777', brand: 'Kia', model: 'Cerato', vin: 'Z94CB41AAHR123457', sts: '77СТ123465', status: 'На линии', currentDriver: 'Морозов Михаил Михайлович', mileage: 89000, category: 'Комфорт', curator: 'Сидоров С.С.', hasFines: false, insuranceExpiringDays: 60, hasDebt: false },
    { id: 11, plate: 'М123ЦЧ777', brand: 'Toyota', model: 'Camry', vin: 'JTNBF4HKXJ1234569', sts: '77СТ123466', status: 'Свободен', currentDriver: null, mileage: 45000, category: 'Комфорт', curator: 'Петров П.П.', hasFines: false, insuranceExpiringDays: 150, hasDebt: false },
    { id: 12, plate: 'Н456ШЩ777', brand: 'Volkswagen', model: 'Jetta', vin: 'WVWZZZ6RZHY123457', sts: '77СТ123467', status: 'На линии', currentDriver: 'Волков Владимир Владимирович', mileage: 123000, category: 'Комфорт', curator: 'Сидоров С.С.', hasFines: false, insuranceExpiringDays: 25, hasDebt: false }
  ],
  ...
  inspections: [
    { id: 1, date: '2024-01-25T10:30:00', plate: 'А123БВ777', type: 'Выдача', mechanicName: 'Механиков М.М.', driverName: 'Иванов Иван Иванович', mileage: 125000, hasDamages: false, hasIncomplete: false, hasLostDocuments: false, notes: 'Все в порядке' },
    { id: 2, date: '2024-01-20T14:15:00', plate: 'Е345КЛ777', type: 'Выдача', mechanicName: 'Механиков М.М.', driverName: 'Козлов Константин Константинович', mileage: 112000, hasDamages: false, hasIncomplete: false, hasLostDocuments: false, notes: 'Комплектность полная' },
    { id: 3, date: '2024-01-18T09:45:00', plate: 'З901ОП777', type: 'Возврат', mechanicName: 'Слесарев С.С.', driverName: 'Новиков Николай Николаевич', mileage: 134500, hasDamages: true, hasIncomplete: false, hasLostDocuments: false, notes: 'Царапина на заднем бампере' },
    { id: 4, date: '2024-01-15T16:20:00', plate: 'Л890ФХ777', type: 'Плановый', mechanicName: 'Слесарев С.С.', driverName: 'Морозов Михаил Михайлович', mileage: 89000, hasDamages: false, hasIncomplete: false, hasLostDocuments: false, notes: null },
    { id: 5, date: '2024-01-12T11:00:00', plate: 'Н456ШЩ777', type: 'Выдача', mechanicName: 'Механиков М.М.', driverName: 'Волков Владимир Владимирович', mileage: 123000, hasDamages: false, hasIncomplete: true, hasLostDocuments: false, notes: 'Отличное состояние' },
    { id: 6, date: '2024-01-10T13:30:00', plate: 'А123БВ777', type: 'Возврат', mechanicName: 'Механиков М.М.', driverName: 'Иванов Иван Иванович', mileage: 125200, hasDamages: false, hasIncomplete: false, hasLostDocuments: true, notes: null },
    { id: 7, date: '2024-01-08T08:15:00', plate: 'М123ЦЧ777', type: 'Выдача', mechanicName: 'Слесарев С.С.', driverName: null, mileage: 45000, hasDamages: false, hasIncomplete: false, hasLostDocuments: false, notes: 'Новое авто' },
    { id: 8, date: '2024-01-05T15:45:00', plate: 'К567ТУ777', type: 'Возврат', mechanicName: 'Механиков М.М.', driverName: 'Федоров Федор Федорович', mileage: 101500, hasDamages: true, hasIncomplete: false, hasLostDocuments: false, notes: 'Трещина на лобовом стекле' },
    { id: 9, date: '2024-01-03T10:00:00', plate: 'В456ГД777', type: 'Плановый', mechanicName: 'Слесарев С.С.', driverName: null, mileage: 89000, hasDamages: false, hasIncomplete: false, hasLostDocuments: false, notes: null },
    { id: 10, date: '2023-12-30T12:00:00', plate: 'Д012ЗИ777', type: 'Возврат', mechanicName: 'Механиков М.М.', driverName: 'Смирнов Сергей Сергеевич', mileage: 98000, hasDamages: false, hasIncomplete: false, hasLostDocuments: false, notes: 'Все исправно' }
  ],
  ...
  events: [
    ...
    { id: 3, carId: 1, date: '2024-12-06T08:46:10', mileage: 215000, type: 'Обнаружено повреждение', status: 'Закрыто', priority: 1, responsible: 'Пилюгин Дмитрий', user: 'Пилюгин Дмитрий', repairRequest: 'Нет', comment: 'Повреждение перед бампера' },
    { id: 4, carId: 1, date: '2025-03-19T12:55:14', mileage: 220000, type: 'Обнаружено повреждение', status: 'Закрыто', priority: 1, responsible: 'Зайцев Виктор', user: 'Зайцев Виктор', repairRequest: 'Нет', comment: '' },
    { id: 5, carId: 1, date: '2025-10-14T12:00:06', mileage: 250000, type: 'Повреждения колёс', status: 'Закрыто', priority: 1, responsible: 'Михаил Бабичев', user: 'Михаил Бабичев', repairRequest: 'Нет', comment: 'прокат диска' },
    ...
    { id: 9, carId: 5, date: '2024-10-10T09:15:00', mileage: 113000, type: 'Осмотр', status: 'Закрыто', priority: 3, responsible: 'Козлов Константин Константинович', user: 'Козлов Константин Константинович', repairRequest: 'Нет', comment: 'Плановый осмотр' },
    { id: 10, carId: 7, date: '2024-11-05T16:45:00', mileage: 135000, type: 'Обнаружено повреждение', status: 'Открыто', priority: 2, responsible: 'Новиков Николай Николаевич', user: 'Новиков Николай Николаевич', repairRequest: 'Нет', comment: 'Царапина на двери' }
  ],
